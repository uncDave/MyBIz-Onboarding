...
public class RegisterSoleProprietorRequest {
    ...
    @NotBlank(message = "CAC Number is required")
    private String cacNumber;
    @NotBlank(message = "CAC Verification document is required")
    private String cacDocumentUrl;
    @NotBlank(message = "CAC Verification name is required")
    ...
    @NotBlank(message = "Utility document is required")
